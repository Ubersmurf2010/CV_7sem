...
void robots(cv::Mat& src, bool debug = true) {
    cv::Mat res = src.clone();
    cv::Mat green(src.size(), CV_8UC1);
    cv::Mat blue(src.size(), CV_8UC1);
    cv::Mat red(src.size(), CV_8UC1);

    unsigned int low_green_H = 70, low_green_S = 50, low_green_V = 50;
    unsigned int high_green_H = 80, high_green_S = 255, high_green_V = 255;

    unsigned int low_blue_H = 90, low_blue_S = 60, low_blue_V = 60;
    unsigned int high_blue_H = 100, high_blue_S = 255, high_blue_V = 255;

    unsigned int low_red_H = 0, low_red_S = 60, low_red_V = 60;
    unsigned int high_red_H = 10, high_red_S = 255, high_red_V = 255;
